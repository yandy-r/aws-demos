...
module "east_vpn" {
  ...
  vpn_connection = {
    east_vpn = {
      customer_gateway_id                  = module.east_vpn.customer_gateway_ids["east_vpn"]
      vpn_gateway_id                       = module.east_vpn.vpn_gateway_ids["east_vpn"]
...
module "west_vpn" {
  ...
  vpn_gateway_attachment = {
    west_vpn = {
      vpc_id         = module.west_hub.vpc_id
      vpn_gateway_id = module.west_vpn.vpn_gateway_ids["west_vpn"]
    }
  }
  ...
  vpn_connection = {
    west_vpn = {
      customer_gateway_id                  = module.west_vpn.customer_gateway_ids["west_vpn"]
      vpn_gateway_id                       = module.west_vpn.vpn_gateway_ids["west_vpn"]
      static_routes_only                   = false
      tunnel1_preshared_key                = var.tunnel1_preshared_key
      tunnel2_preshared_key                = var.tunnel2_preshared_key
