locals {
  ...
  spoke_vpc_ids             = [module.spoke_1_vpc.vpc_id, module.spoke_2_vpc.vpc_id, module.spoke_3_vpc.vpc_id]
  spoke_1_subnet_ids        = module.spoke_1_vpc.private_subnets.*.id
  spoke_2_subnet_ids        = module.spoke_2_vpc.private_subnets.*.id
  spoke_3_subnet_ids        = module.spoke_3_vpc.private_subnets.*.id
